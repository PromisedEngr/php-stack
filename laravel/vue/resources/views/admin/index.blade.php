          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <div class="inner">
                ...
                <h3>{{\App\Models\User::where('role','1')->where('status','active')->count()}}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <div class="inner">
                ...
                <h3>{{\App\Models\User::where('role','1')->where('status','inactive')->count()}}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <div class="inner">
                ...
                <h3>{{\App\Models\Voucher::where('status','active')->count()}}</h3>
