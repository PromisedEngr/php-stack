...
<!-----------vendor registartion----------->
        <div class="container py-5">
            ...
            <!-- <form action="javascript:void(0)" id="forgetpassword" name="forgetpassword" method="POST">
                <div class="form-row">
...
<script type="text/javascript" src="{{ asset('public/assets/js/view/vendors/forgetpassword.js') }} "></script>
