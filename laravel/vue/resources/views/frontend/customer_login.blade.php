...
<!-----------customer registartion----------->
        <!-- <div class="container py-5">
            <form action="javascript:void(0)" id="customer_login" name="customer_login" method="POST">
                <div class="form-row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group already_user">
                        <p>Don't have an account? <a href="{{ url('/registration') }}" class="txt_color_green">Register here</a></p>
                        <a class="txt_color_green" href="{{ url('/customer_forgetpassword') }}">Forgot Password</a>
                        
                      </div>
                    </div>
                </div>
            </form>
            <p class="text-center fl-success" id="successcustomer_login" style="display:none;"></p>  
            <p class="text-center fl-success" id="errorcustomer_login" style="display:none;"></p>  
                ...
                <div class="col-lg-4 offset-lg-3 col-sm-6 offset-sm-1">
                    <div class="login-form">
                        ...
                        <form action="javascript:void(0)" id="customer_login" name="customer_login" method="POST">
                            ...
                            <a href="{{ url('/customer_forgetpassword') }}" class="forgot-password">Forgot Password</a>
                               <a href="javascript:void(0)" class="cleaning-expert">New to Cleaning Expert?  </a>
                               <a href="{{ url('/registration') }}" class="signup">Sign Up</a>
                        </form>
                        <p class="text-center fl-success" id="successcustomer_login" style="display:none;"></p>  
                        <p class="text-center fl-success" id="errorcustomer_login" style="display:none;"></p> 
                    </div>
